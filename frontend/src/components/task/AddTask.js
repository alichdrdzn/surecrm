    ...
    return (
        <div>
            ...
            >
                ...
                >
                    <Typography variant="h6">{t('Create Task')}</Typography>
                    <Typography>
                        <ClearIcon
                            onClick={handleClose}
                        ...
                        >
                            ...
                            >
                                <Grid item xs={12} sm={6} md={6}>
                                    <FormLabel id="demo-row-radio-buttons-group-label">{t('Subject')}</FormLabel>
                                    <TextField
                                        id="subject"
                                        name="subject"
                                        label=""
                                ...
                                <Grid item xs={12} sm={6} md={6}>
                                    <FormControl>
                                        ...
                                        <RadioGroup
                                            ...
                                            onChange={formik.handleChange}
                                        >
                                            <FormControlLabel value="Lead" control={<Radio />} label={t('Lead')} />
                                            <FormControlLabel value="Contact" control={<Radio />} label={t('Contact')} />
                                        </RadioGroup>
                                        <FormHelperText
                                            error={
                                ...
                                <Grid item xs={12} sm={4}>
                                    ...
                                    <FormControl fullWidth>
                                        ...
                                        >
                                            <MenuItem value="Note Started">{t('Note Started')}</MenuItem>
                                            <MenuItem value="In Progress">{t('In Progress')}</MenuItem>
                                            <MenuItem value="Completed">{t('Completed')}</MenuItem>
                                            <MenuItem value="Pending Input">{t('Pending Input')}</MenuItem>
                                            <MenuItem value="Deferred">{t('Deferred')}</MenuItem>
                                        </Select>
                                        <FormHelperText
                                            error={
                                ...
                                <Grid item xs={12} sm={6} md={4}>
                                    <FormLabel id="demo-row-radio-buttons-group-label">{t('Assign To')}</FormLabel>
                                    <FormControl fullWidth>
                                        <Select
                                            labelId="demo-simple-select-label"
                                            id=""
                                ...
                                </Grid>
                                {
                                    ...
                                    <Grid item xs={12} sm={12} md={12}>
                                        <FormLabel id="demo-row-radio-buttons-group-label">{t('Related To Lead')}</FormLabel>
                                        <FormControl fullWidth>
                                            <Autocomplete
...

                                {
                                    ...
                                    <Grid item xs={12} sm={12} md={12}>
                                        <FormLabel id="demo-row-radio-buttons-group-label">{t('Related To Contact')}</FormLabel>
                                        <FormControl fullWidth>
                                            <Autocomplete
                                ...
                                <Grid item xs={12} sm={12}>
                                    <FormLabel id="demo-row-radio-buttons-group-label">{t('Note')}</FormLabel>
                                    <TextField
                                        id="Note"
                                        name="note"
                                        label=""
