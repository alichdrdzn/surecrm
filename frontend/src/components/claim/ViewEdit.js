    ...
    return (
        <div>
            ...
            >
                ...
                >
                    <Typography variant="h6">{t('View and Update Claim')}</Typography>
                    <Typography>
                        <ClearIcon
                            onClick={handleClose}
                        ...
                        >
                            ...
                            >
                                ...
                                <Grid item xs={12} sm={12}>
                                    <FormControl fullWidth>
                                        <FormLabel>{t('Claim Status')}</FormLabel>
                                        <Select
                                            labelId="demo-simple-select-label"
                                            id="claimStatus"
                                            name="claimStatus"
                                        ...
                                        >
                                            ...
                                            <MenuItem value="Under Investigation">{t('Under Investigation')}</MenuItem>
                                ...
                                <Grid item xs={12} sm={12}>
                                    <FormLabel>{t('Claim Notes')}</FormLabel>
                                    <TextField
                                        id="claimNotes"
                                        name="claimNotes"
                                        size="small"
