                ...
                >
...

                    {
                        ...
                        <MenuItem onClick={props.handleOpenDelete} disableRipple >
                            <DeleteIcon />{t('Delete')}</MenuItem>
                    }

                    {
                        props.handleExport && <MenuItem disableRipple onClick={props.handleExport}>
                            <SaveAltIcon />{t('Export CSV')}</MenuItem>
                    }
                </StyledMenu>
                <Button variant="contained" color="secondary" onClick={props.back} startIcon={<ArrowBackIosIcon />}>{t('Back')}</Button>
            </Stack>
        </div>
    )
}
