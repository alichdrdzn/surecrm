            ...
            <Card style={{ borderTopLeftRadius: "0px", borderTopRightRadius: "0px" }}>
                <Box p={3}>
                    <Grid container display="flex" spacing={4}>
                        ...
                        <Grid item xs={12} sm={6} >
                            <Grid style={{ borderBottom: "1.5px dashed", borderBottomColor: Palette.grey[400] }} pb={2}>
                                ...
                                <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
                                    ...
                                    {data?.alternatePhoneNumber ? <CallButton number={data.alternatePhoneNumber} contactId={data?._id} /> : null}
                                </div>
                            </Grid>
                            ...
                            <Grid style={{ borderBottom: "1.5px dashed", borderBottomColor: Palette.grey[400] }} py={2}>
                                <Typography variant="body1">{t('Preferred Contact Method :')}</Typography>
                                <Typography variant="body2" color={Palette.grey[600]} >{data?.preferredContactMethod ? data?.preferredContactMethod : "--"}</Typography>
                            </Grid>
                        </Grid>
                        <Grid item xs={12} sm={6} >
                            <Grid style={{ borderBottom: "1.5px dashed", borderBottomColor: Palette.grey[400] }} pb={2}>
                                <Typography variant="body1">{t('Additional Email :')}</Typography>
                        ...
                        <Grid item xs={12} sm={6} >
                            <Grid style={{ borderBottom: "1.5px dashed", borderBottomColor: Palette.grey[400] }} pb={2}>
                                <Typography variant="h4" pb={2}>{t('Referral Information :-')}</Typography>
                                <Typography variant="body1">{t('Referral source (if applicable):')}</Typography>
                        ...
                        <Grid item xs={12} sm={6}>
                            ...
                            <Grid container display="flex" spacing={4}>
                                <Grid item xs={12} sm={6}>
                                    <Grid style={{ borderBottom: "1.5px dashed", borderBottomColor: Palette.grey[400] }} pb={2}>
                                        <Typography variant="body1">{t('Referral Contact Name:')}</Typography>
                                        <Typography variant="body2" color={Palette.grey[600]}>{data?.referralContactName ? data?.referralContactName : "--"}</Typography>
                                    </Grid>
                                </Grid>
                                <Grid item xs={12} sm={6}>
                                    <Grid style={{ borderBottom: "1.5px dashed", borderBottomColor: Palette.grey[400] }} pb={2}>
                                        <Typography variant="body1">{t('Relationship to Referrer:')}</Typography>
                        ...
                        <Grid item xs={12} sm={12}>
                            <Typography variant="h4">{t('Communication Preferences :-')}</Typography>
                        </Grid>
                        <Grid item xs={12} sm={6} >
                            <Grid style={{ borderBottom: "1.5px dashed", borderBottomColor: Palette.grey[400] }} pb={2}>
                                <Typography variant="body1">{t('Preferences For Marketing Communications :')}</Typography>
                        ...
                        <Grid item xs={12} sm={6} >
                            <Grid style={{ borderBottom: "1.5px dashed", borderBottomColor: Palette.grey[400] }} pb={2}>
                                <Typography variant="body1">{t('Preferred Language For Communication :')}</Typography>
