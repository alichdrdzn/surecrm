...
const Lead = ({ rows, toggleVisibilityLead, isVisibleLead, _id, setUserAction }) => {
  ...
  const columns = [
    ...
    { field: "lastName", headerName: t('Last Name'), flex: 1, cellClassName: "name-column--cell--capitalize" },
    { field: "gender", headerName: t('Gender'), flex: 1 },
    { field: "phoneNumber", headerName: t('Phone Number'), flex: 1 },
    { field: "emailAddress", headerName: t('Email Address'), flex: 1 },
  ];
        ...
        <Grid container display="flex" alignItems="center">
          <Stack direction="row" alignItems="center" justifyContent={"space-between"} width={"100%"}>
            <Stack direction="row" spacing={1} alignItems={"center"}>
              ...
              <LeaderboardIcon />
              <Typography variant="h6">{t('Lead')}</Typography>
            </Stack>
