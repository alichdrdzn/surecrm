...
const Policy = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      headerName: t('Policy start date'),
      flex: 1,
    ...
    <>
      ...
      <Container>
          <Stack direction="row" alignItems="center" justifyContent="space-between" mb={5}>
            ...
            <Button variant="contained" startIcon={<Iconify icon="eva:plus-fill" />} onClick={handleOpenAdd}>{t('New Policy')}</Button>
          </Stack>
          <TableStyle>
            <Box width="100%">
