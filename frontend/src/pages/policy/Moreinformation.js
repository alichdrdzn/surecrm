                    ...
                    <Grid container display="flex" spacing={4}>
                        <Grid item xs={12} sm={6} >
                            <Grid style={{ borderBottom: "1.5px dashed", borderBottomColor: Palette.grey[400] }} pb={2}>
                                ...
                                <Typography variant="body1">{t("Insured person's name :")}</Typography>
                                {
                                    data?.contact_id ?
                            ...
                            <Grid style={{ borderBottom: "1.5px dashed", borderBottomColor: Palette.grey[400] }} py={2}>
                                <Typography variant="body1">{t("Insured person's date of birth :")}</Typography>
                            ...
                            <Grid style={{ borderBottom: "1.5px dashed", borderBottomColor: Palette.grey[400] }} py={2}>
                                <Typography variant="body1">{t('Relationship to the insured (if applicable) :')}</Typography>
                                <Typography variant="body2" color={Palette.grey[600]}>{data?.relationshipToTheInsured ? data?.relationshipToTheInsured : "--"}</Typography>
                            </Grid>
                            <Grid style={{ borderBottom: "1.5px dashed", borderBottomColor: Palette.grey[400] }} py={2}>
                                <Typography variant="h4" py={2} >{t('Additional Insured :-')}</Typography>
                                <Typography variant="body1">{t("Additional insured person's name :")}</Typography>
                            ...
                            <Grid style={{ borderBottom: "1.5px dashed", borderBottomColor: Palette.grey[400] }} py={2}>
                                <Typography variant="body1">{t("Additional Insured person's date of birth :")}</Typography>
                                <Typography variant="body2" color={Palette.grey[600]}>
                                    {
                            ...
                            <Grid style={{ borderBottom: "1.5px dashed", borderBottomColor: Palette.grey[400] }} py={2}>
                                <Typography variant="h4" py={2} >{t('Underwriting Information :-')}</Typography>
                            ...
                            <Grid style={{ borderBottom: "1.5px dashed", borderBottomColor: Palette.grey[400] }} py={2}>
                                <Typography variant="body1">{t('Decisions Or Remark:')}</Typography>
                        ...
                        <Grid item xs={12} sm={6}>
                            <Grid style={{ borderBottom: "1.5px dashed", borderBottomColor: Palette.grey[400] }} pb={2}>
                                <Typography variant="h4" pb={2} >{t("Insured person's contact information :-")}</Typography>
                            ...
                            <Grid style={{ borderBottom: "1.5px dashed", borderBottomColor: Palette.grey[400] }} py={2}>
                                <Typography variant="h4" py={2} >{t('Additional Insured contact information :-')}</Typography>
                                <Typography variant="body1">{t('Phone Number :')}</Typography>
                            ...
                            <Grid style={{ borderBottom: "1.5px dashed", borderBottomColor: Palette.grey[400] }} py={2}>
                                <Typography variant="h4" py={2} >{t('Policy Premiums and Payments :-')}</Typography>
                                <Typography variant="body1">{t('Premium amount :')}</Typography>
                                <Typography variant="body2" color={Palette.grey[600]}>{data?.premiumAmount ? data?.premiumAmount : "--"}</Typography>
                            </Grid>
                            <Grid style={{ borderBottom: "1.5px dashed", borderBottomColor: Palette.grey[400] }} py={2}>
                                <Typography variant="body1">{t('Frequency of premium payments :')}</Typography>
