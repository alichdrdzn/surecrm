                ...
                <DialogContent dividers>
                    <form>
                        <DialogContentText
                            ...
                            tabIndex={-1}
                        >
                            <Typography style={{ marginBottom: "15px" }} variant="h6">{t('Policy Details')}</Typography>
                            <Grid
                                container
                                rowSpacing={3}
                            ...
                            >
                                <Grid item xs={12} sm={6} md={6}>
                                    <FormControl fullWidth>
                                        ...
                                        >
                                            <MenuItem value="Auto Insurance">{t('Auto Insurance')}</MenuItem>
                                ...
                                <Grid item xs={12} sm={6} md={6}>
                                    <FormControl fullWidth>
                                        <FormLabel>{t('Policy status')}</FormLabel>
                                        <Select
                                            labelId="demo-simple-select-label"
                                            id="policyStatus"
                                            name="policyStatus"
                            ...
                            <Typography
                                ...
                                variant="h6"
                            >{t('Policy Coverage Details')}</Typography>
                            <Grid
                                container
                                rowSpacing={3}
                                columnSpacing={{ xs: 0, sm: 5, md: 4 }}
                            >
                                <Grid item xs={12} sm={6} md={6}>
                                    <FormLabel>{t('Coverage Amounts')}</FormLabel>
                                    <TextField
                                        id="coverageAmounts"
                                ...
                                <Grid item xs={12} sm={6} md={6}>
                                    <FormLabel>{t('Deductibles')}</FormLabel>
                                    <TextField
                                        id="deductibles"
                                        name="deductibles"
                                        size='small'
                            ...
                            >
                                <Grid item xs={12} sm={6} md={6}>
                                    <FormLabel>{t('Insured Person Name')}</FormLabel>
                                    <TextField
                                ...
                                <Grid item xs={12} sm={12} md={12}>
                                    <FormLabel>{t('Relationship to the insured')}</FormLabel>
                                    <TextField
                            ...
                            <Typography
                                style={{ marginBottom: "15px", marginTop: "15px" }}
                                variant="h6"
                            >{t("Insured person's contact information")}</Typography>
                            <Grid
                                container
                                rowSpacing={3}
                                columnSpacing={{ xs: 0, sm: 5, md: 4 }}
                            ...
                            <Typography
                                style={{ marginBottom: "15px", marginTop: "15px" }}
                                variant="h6"
                            >{t('Additional Insured')}</Typography>
                            <Grid
                                container
                                rowSpacing={3}
                                columnSpacing={{ xs: 0, sm: 5, md: 4 }}
                            >
                                <Grid item xs={12} sm={6} md={6}>
                                    <FormLabel>{t('Person Name')}</FormLabel>
                                    <TextField
                            ...
                            <Typography
                                style={{ marginBottom: "15px", marginTop: "15px" }}
                                variant="h6"
                            >{t("Additional insured person's contact information")}</Typography>
                            <Grid
                                container
                                rowSpacing={3}
                                columnSpacing={{ xs: 0, sm: 5, md: 4 }}
                            >
                                ...
                                <Grid item xs={12} sm={6} md={6}>
                                    ...
                                    />
                                    {formik.values.additionalInstagramProfile && <a href={`https://www.instagram.com/${formik.values.additionalInstagramProfile}`} target="_blank" rel="noreferrer">{t('Link')}</a>}
                                </Grid>
                                <Grid item xs={12} sm={6} md={6}>
                                    <FormLabel>{t('Twitter profile')}</FormLabel>
                                    <TextField
                                    ...
                                    />
                                    {formik.values.additionalTwitterProfile && <a href={`https://twitter.com/${formik.values.additionalTwitterProfile}`} target="_blank" rel="noreferrer">{t('Link')}</a>}
                                </Grid>
                            </Grid>
                            <Typography
                                style={{ marginBottom: "15px", marginTop: "15px" }}
                                variant="h6"
                            >{t('Policy Premiums and Payments')}</Typography>
                            <Grid
                                container
                                rowSpacing={3}
                                columnSpacing={{ xs: 0, sm: 5, md: 4 }}
                            >
                                <Grid item xs={12} sm={6} md={6}>
                                    <FormLabel>{t('Premium Amount')}</FormLabel>
                                    <TextField
                                        id="premiumAmount"
                                        name="premiumAmount"
                                        type="number"
                                ...
                                <Grid item xs={12} sm={6} md={6}>
                                    <FormControl fullWidth>
                                        <FormLabel>{t('Premium Payments')}</FormLabel>
                                        <Select
                                            labelId="demo-simple-select-label"
                            ...
                            <Typography
                                style={{ marginBottom: "15px", marginTop: "15px" }}
                                variant="h6"
                            >{t('Underwriting Information')}</Typography>
                            <Grid
                                container
                                rowSpacing={3}
                                columnSpacing={{ xs: 0, sm: 5, md: 4 }}
                            >
                                ...
                                <Grid item xs={12} sm={6} md={6}>
                                    <FormControl fullWidth>
                                        <FormLabel>{t('Underwriter Remarks')}</FormLabel>
                                        <Select
                                            labelId="demo-simple-select-label"
                                            ...
                                            onChange={formik.handleChange}
                                        >
                                            <MenuItem value="Policyholder has a clean driving record">{t('Policyholder has a clean driving record')}</MenuItem>
                                            <MenuItem value="Policyholder's property located in a low-risk area">{t("Policyholder's property located in a low-risk area")}</MenuItem>
