                ...
                return (
                    <Box onClick={handleFirstNameClick}>
                        <Stack direction={"row"} spacing={2}>
                            <a href={downloadUrl}><Button variant='contained' size='small'>{t('Download')}</Button></a>
                            <Button variant='outlined' size='small' color='error' onClick={() => deleteFile(params.row._id)}>{t('Delete')}</Button>
                        </Stack>
                    </Box>
                );
            }
        ...
        <>
            ...
            <Container>
                <Stack direction="row" alignItems="center" justifyContent="space-between" mb={5}>
                    ...
                    <Button variant="contained" startIcon={<Iconify icon="eva:plus-fill" />} onClick={handleOpenAdd}>{t('New Document')}</Button>
                </Stack>
                <TableStyle>
                    <Box width="100%">
